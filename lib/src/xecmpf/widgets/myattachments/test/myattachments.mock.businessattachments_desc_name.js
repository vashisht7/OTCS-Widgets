...
define(['csui/lib/underscore'
    ...
    var businessAttachments_desc_name =
        {
            "actions": {
                "data": {
            ...
            "links": {
                "data": {
                    "self": {
                        "body": "",
                        "content_type": "",
                        "href": "/api/v2/nodes/123652/businessattachments?expand=user&limit=30&page=1&sort=desc_name&metadata",
                        "method": "GET",
                        "name": ""
                    }
                }
    ...
    return businessAttachments_desc_name;
